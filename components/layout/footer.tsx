...
const Footer = ({ removeClass }: FooterProps) => {
  return (
    <>
        ...
        <div className="container">
                ...
                <div className="newsletter">
                  ...
                  <form className="input-group form-subcriber mt-30 d-flex">
                    ...
                    <label className="mt-20">
                      <input className="mr-5" name="name" type="checkbox" value="1" required /> I agree to the
          ...
          <div className="footer-copy-right pt-30 mt-20 wow fadeInUp animated">
            ...
            <p className="float-md-right font-small text-muted">
              Design by
              <Link href="https://alithemes.com" target="_blank">
                AliThemes
              </Link>
              | All rights reserved
            </p>
