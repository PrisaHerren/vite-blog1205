...
const Header = ({ addClass, openSearch }: any) => {
  return (
    <>
            ...
            <div className="row pt-20 pb-20">
              <div className="col-md-3 col-xs-6">
                <Link href="/" className="logo">
                  <img src="/assets/imgs/theme/logo.png" alt="" />
                </Link>
              </div>
              <div className="col-md-9 col-xs-6 text-right header-top-right ">
                <ul className="list-inline nav-topbar d-none d-md-inline">
                  ...
                  <li className="list-inline-item">
                    <Link href="http://demos.alithemes.com/html/stories/docs/" className="flex items-center">
