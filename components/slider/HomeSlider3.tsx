    ...
    <div>
      <Slider {...settings} className="featured-slider-3-items">
        {data.slice(4, 6).map((item, i) => (
          <div className="slider-single overflow-hidden border-radius-10" key={i}>
            <div className="post-thumb position-relative">
              <div className="thumb-overlay position-relative" style={{ backgroundImage: `url(/assets/imgs/news/${item.img})` }}>
