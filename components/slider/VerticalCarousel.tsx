      ...
      <div className="featured-slider-2">
                    ...
                    <div className="post-content-overlay">
                      <div className="container">
                        ...
                        <div className="entry-meta meta-1 font-small text-white mt-10 pr-5 pl-5">
                          ...
                          <span className="hit-count has-dot">{item.views} Views</span>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <div className="container position-relative">
          ...
          <div className="featured-slider-2-nav-cover">
            ...
            >
              {data.slice(1, 6).map((item, i) => (
                <div className="slider-post-thumb mr-15 mt-20 position-relative" key={i}>
                  <div className="d-flex hover-up-2 transition-normal">
                    <div className="post-thumb post-thumb-80 d-flex mr-15 border-radius-5">
                      <img className="border-radius-5" src={`/assets/imgs/news/${item.img}`} alt="" />
                    </div>
                    <div className="post-content media-body text-white">
                      <h5 className="post-title mb-15 text-limit-2-row">{item.title}</h5>
                      <div className="entry-meta meta-1 float-left font-x-small text-uppercase">
                        <span className="post-on text-white">{item.date}</span>
                        <span className="post-by has-dot text-white">{item.views} Views</span>
                      </div>
                    </div>
                  </div>
                </div>
