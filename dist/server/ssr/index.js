import { a as __toESM, n as __commonJSMin, r as __exportAll, t as require_react } from "./_next/static/react-BSUe0WV4.js";
import { c as scrollToHashTarget, g as assertSafeNavigationUrl, l as isAbsoluteOrProtocolRelativeUrl, m as toSameOriginAppPath, n as matchRoutePatternPrefix, o as splitPathnameForRouteMatch, p as toBrowserNavigationHref, s as isUnknownRecord, t as matchRoutePattern, u as isHashOnlyBrowserUrlChange, x as stripBasePath, y as addBasePathToPathname } from "./_next/static/route-pattern-C9xOXorn.js";
...
//#endregion
//#region node_modules/vinext/dist/client/navigation-runtime.js
var NAVIGATION_RUNTIME_SYMBOL_DESCRIPTION = "vinext.navigationRuntime";
var NAVIGATION_RUNTIME_KEY = Symbol.for(NAVIGATION_RUNTIME_SYMBOL_DESCRIPTION);
...
function getOrCreateAls(key) {
	...
	return _g$3[sym] ??= new AsyncLocalStorage$1();
}
//#endregion
...
*/
var _FALLBACK_KEY$1 = Symbol.for("vinext.navigation.fallback");
var _g$1 = globalThis;
var _als$1 = getOrCreateAls("vinext.navigation.als");
...
function Slot({ id, children, parallelSlots }) {
	...
	if (isTransportMetadataValue(element)) return null;
...
//#endregion
//#region node_modules/vinext/dist/server/app-rsc-embedded-chunks.js
...
var _FALLBACK_KEY = Symbol.for("vinext.rootParams.fallback");
var _g = globalThis;
var _als = getOrCreateAls("vinext.rootParams.als");
_g[_FALLBACK_KEY] ??= { rootParams: null };
...
//#endregion
//#region node_modules/vinext/dist/server/app-ssr-error-meta.js
...
var client_references_default = {
	"01678d3b938d": async () => {
		const m = await import("./_next/static/page-BbZkA3ry.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"0b874ad30386": async () => {
		const m = await import("./_next/static/default-global-error-VyTHm7m6.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"15c18cfaeeff": async () => {
		const m = await import("./_next/static/layout-segment-context-B54es4mg.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"1d1da7b80cdd": async () => {
		const m = await import("./_next/static/page-Bqqr06hI.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"30dfa470f0f4": async () => {
		const m = await import("./_next/static/page-C1F2qkC5.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"3c7986dbbbff": async () => {
		const m = await import("./_next/static/page-B6EKPjwy.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"3cfcfe148364": async () => {
		const m = await import("./_next/static/page-DYUl4UDh.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"42be576f4803": async () => {
		const m = await import("./_next/static/page-4tb6eyXl.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"4d626348654e": async () => {
		const m = await import("./_next/static/page-yWrnVrj_.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"5793cc191a46": async () => {
		const m = await import("./_next/static/page-C3AcQqtF.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"593f344dc510": async () => {
		const m = await import("./_next/static/error-boundary-BrLSelQJ.js");
		return {
			get "ErrorBoundary"() {
	...
	"666bc2d021c0": async () => {
		const m = await import("./_next/static/page-DSIBE3Wv.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"6efdf509a785": async () => {
		const m = await import("./_next/static/page-B09xDTKl.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	...
	"8deae139277f": async () => {
		const m = await import("./_next/static/page-D0T_dLda.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"911de7aae36e": async () => {
		const m = await import("./_next/static/page-CbXt3Q-1.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"93eece74a0c0": async () => {
		const m = await import("./_next/static/page-DN9KFnoy.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"960e34d10146": async () => {
		const m = await import("./_next/static/page-BV5P1qDM.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"a7c04bec8711": async () => {
		const m = await import("./_next/static/page-CjedWpkt.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"ae66bd113450": async () => {
		const m = await import("./_next/static/page-CzXNImyh.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"bf52759d0291": async () => {
		const m = await import("./_next/static/page-C2D18bu-.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"c03847ade71a": async () => {
		const m = await import("./_next/static/loading-ClEPMjbM.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"c8bf7ea03887": async () => {
		const m = await import("./_next/static/page-DZcBx3_P.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"d37dce2abe21": async () => {
		const m = await import("./_next/static/page-CWElGeXd.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"d397b21a4133": async () => {
		const m = await import("./_next/static/page-BbIGbz-W.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"dc59ba9cc4aa": async () => {
		const m = await import("./_next/static/ScrollProgress-cA_xbYlQ.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"e446c8de6a62": async () => {
		const m = await import("./_next/static/page-BoNhMcBA.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"e4e7c58fcf80": async () => {
		const m = await import("./_next/static/page-BPlMGZ47.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"f7b08fcab122": async () => {
		const m = await import("./_next/static/page-DPW2MQ-i.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"fae6fdeed8dd": async () => {
		const m = await import("./_next/static/page-CRRDFBzJ.js");
		return { get "default"() {
			return m["default"];
		} };
	}
	...
	return runWithNavigationContext(async () => {
		...
		return runWithRootParamsScope(options?.rootParams ?? {}, async () => {
			try {
				...
				const flightRootElement = (0, import_react.createElement)(VinextFlightRoot);
				const root = AppRouterContext ? (0, import_react.createElement)(AppRouterContext.Provider, { value: appRouterInstance }, flightRootElement) : flightRootElement;
				...
				const bootstrapModuleUrl = extractBootstrapModuleUrl(await Promise.resolve("import(" + JSON.stringify(assetsManifest.clientEntryUrl) + ")"));
...
//#endregion
export { VINEXT_MOUNTED_SLOTS_HEADER as C, AppElementsWire as S, APP_RSC_RENDER_MODE_PREFETCH_LOADING_SHELL as _, getPrefetchInterceptionContext as a, hasAppNavigationRuntime as b, navigateClientSide as c, useRouter as d, app_ssr_entry_default as default, ReadonlyURLSearchParams as f, stripRscSuffix as g, stripRscCacheBustingSearchParam as h, handleSsr, getPrefetchCache as i, prefetchRscResponse as l, createRscRequestUrl as m, getLayoutSegmentContext as n, getPrefetchedUrls as o, createRscRequestHeaders as p, getMountedSlotsHeader as r, isRedirectError as s, require_jsx_runtime as t, usePathname as u, createExternalHistoryStatePreservingMetadata as v, registerNavigationRuntimeFunctions as x, getNavigationRuntime as y };
