...
// Sử dụng dynamic import cho các components client-side
const PostCarousel1 = dynamic(() => import("../components/slider/PostCarousel1"), {
  ssr: false,
            ...
            <div className="loop-grid mb-30">
              <div className="row">
                ...
                {post.slice(1, 5).map((item, i) => (
                  <article className="col-lg-4 col-md-6 mb-30 wow fadeInUp animated" data-wow-delay="0.2s" key={i}>
                    ...
                    <div className="loop-list loop-list-style-1">
                      <div className="row">
                        {post.slice(4, 8).map((item, i) => (
                          <article className="col-md-6 mb-30 wow fadeInUp animated" data-wow-delay="0.2s" key={item.id}>
                            <div className="post-card-1 border-radius-10 hover-up">
                              <div
                                className="post-thumb thumb-overlay img-hover-slide position-relative"
                                style={{
                  ...
                  <div className="widget-area">
                    <div className="sidebar-widget widget-about mb-50 pt-30 pr-30 pb-30 pl-30 bg-white border-radius-5 has-border  wow fadeInUp animated">
                      {author.slice(0, 1).map((item, i) => (
                        <div key={item.id}>
                          <img className="about-author-img mb-25" src={`/assets/imgs/authors/${item.img}`} alt="" />
                    ...
                    <div className="sidebar-widget widget-latest-posts mb-50 wow fadeInUp animated">
                      ...
                      <div className="post-block-list post-module-1">
                        <ul className="list-post">
                          {post.slice(1, 5).map((item, i) => (
                            <li className="mb-30 wow fadeInUp animated" key={item.id}>
