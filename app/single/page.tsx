        ...
        <main className="bg-grey pb-30">
          <div className="container single-content">
            <div className="entry-header entry-header-style-1 mb-50 pt-50">
              <h1 className="entry-title mb-50 font-weight-900">The effect of livestock on the physiological condition of roe deer is modulated by habitat quality</h1>
              <div className="row">
                ...
                <div className="col-md-6 text-right d-none d-md-inline">
                  <ul className="header-social-network d-inline-block list-inline mr-15">
                    ...
                    <li className="list-inline-item">
                      <a href="#" className="social-icon fb text-xs-center" target="_blank">
                        <i className="elegant-icon social_facebook"></i>
                      </a>
                    </li>
                    <li className="list-inline-item">
                      <a href="#" className="social-icon tw text-xs-center" target="_blank">
                        <i className="elegant-icon social_twitter "></i>
                      </a>
                    </li>
                    <li className="list-inline-item">
                      <a href="#" className="social-icon pt text-xs-center" target="_blank">
            ...
            <article className="entry-wraper mb-50">
              ...
              <div className="entry-bottom mt-50 mb-30 wow fadeIn animated">
                <div className="tags">
                  <span>Tags: </span>
                  <Link href="/category">deer</Link>
                  <Link href="/category">nature</Link>
                  <Link href="/category">conserve</Link>
                </div>
              </div>
                ...
                <div className="author-info">
                  <h4 className="font-weight-bold mb-20">
                    <span className="vcard author">
                      <span className="fn">
                        <Link href="/author">Barbara Cartland</Link>
                      </span>
                    </span>
                  </h4>
                      ...
                      <div className="row mb-40 list-style-2">
                        ...
                        <div className="col-md-8 align-self-center">
                          <div className="post-content">
                            ...
                            <h5 className="post-title font-weight-900 mb-20">
                              <Link href="/#">10 Easy Ways to Be Environmentally Conscious At Home</Link>
                            </h5>
                            <div className="entry-meta meta-1 float-left font-x-small text-uppercase">
                    ...
                    <div className="user justify-content-between d-flex">
                      ...
                      <div className="desc">
                        ...
                        <div className="d-flex justify-content-between">
                          <div className="d-flex align-items-center">
                            <h5>
                              <Link href="/#">Agatha Christie</Link>
                            </h5>
