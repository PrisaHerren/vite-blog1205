                    ...
                    <div className="col-lg-8">
                      <div className="single-content2">
                            ...
                            <div className="col-md-6">
                              <div className="entry-meta align-items-center meta-2 font-small color-muted">
                                <p className="mb-5">
                                  ...
                                  By
                                  <Link href="/author">
                                    <span className="author-name font-weight-bold">{singleData.author}</span>
                                  </Link>
                                </p>
                        ...
                        <figure className="image mb-30 m-auto text-center border-radius-10">
                          <img className="border-radius-10" src={`/assets/imgs/news/${singleData.img}`} alt="post-title" />
                        </figure>
                        ...
                        <article className="entry-wraper mb-50">
                          ...
                          <div className="comments-area">
                            ...
                            {comments.map((item, i) => (
                              <div key={`${item.name}-${i}`} className="comment-list wow fadeIn animated">
                                ...
                                {item.reply &&
                                  item.reply.map((cmntr, i) => (
                                    <React.Fragment key={`${cmntr.name}-reply-${i}`}>
