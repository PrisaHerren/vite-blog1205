...
const SingleVendor = () => {
  ...
  useEffect(() => {
    setSingleData(data.find((data: BlogPost) => data.id == Number(id)) || null);
    setLoading(false);
  }, [id]);
  if (loading) {
    return (
              ...
              <div className="container single-content">
                  ...
                  <div className="row">
                    <div className="col-md-6 mb-md-0 mb-sm-3">
                      <figure className="mb-0 mt-lg-0 mt-3 border-radius-5">
                        <img className=" border-radius-5" src={`/assets/imgs/news/${singleData.img}`} alt="" />
                      </figure>
                    </div>
                    <div className="col-md-6 align-self-center">
                      <div className="post-content">
                        <div className="entry-meta meta-0 mb-15 font-small">
                          <Link href="/category">
                            <span className="post-cat position-relative text-info">{singleData.category}</span>
                          </Link>
                          <Link href="/category">
                            <span className="post-cat position-relative text-success">{singleData.category}</span>
                          </Link>
                        </div>
                        <h1 className="entry-title mb-30 font-weight-900">The Best Time to Travel to Cambodia</h1>
                        <p className="excerpt mb-30">As school districts across the United States consider whether and how to restart in-person classes, their challenge is complicated by a pair of fundamental uncertainties.</p>
                        <div className="entry-meta align-items-center meta-2 font-small color-muted">
                          <p className="mb-5">
                            ...
                            By
                            <Link href="/author">
                              <span className="author-name font-weight-bold">Barbara Cartland</span>
                            </Link>
                          </p>
                ...
                <article className="entry-wraper mb-50">
                  ...
                  <div className="single-social-share clearfix wow fadeIn animated">
                    ...
                    <ul className="header-social-network d-inline-block list-inline float-md-right mt-md-0 mt-4">
                      ...
                      <li className="list-inline-item">
                        <Link href="/#" className="social-icon fb text-xs-center" target="_blank">
                          <i className="elegant-icon social_facebook"></i>
                        </Link>
                      </li>
                      <li className="list-inline-item">
                        <Link href="/#" className="social-icon tw text-xs-center" target="_blank">
                          <i className="elegant-icon social_twitter "></i>
                        </Link>
                      </li>
                      <li className="list-inline-item">
                        <Link href="/#" className="social-icon pt text-xs-center" target="_blank">
                    ...
                    <div className="author-info">
                      <h4 className="font-weight-bold mb-20">
                        <span className="vcard author">
                          <span className="fn">
                            <Link href="/author">{singleData.author}</Link>
                          </span>
                        </span>
                      </h4>
                    ...
                    <div className="post-module-3">
                      ...
                      <div className="loop-list loop-list-style-1">
                        {data.slice(1, 3).map((item, i) => (
                          <article className="hover-up-2 transition-normal wow fadeInUp animated" key={i}>
                              ...
                              <div className="col-md-4">
                                <div className="post-thumb position-relative border-radius-5">
                                  ...
                                  <ul className="social-share">
                                    ...
                                    <li>
                                      <Link href="/#" className="fb" title="Share on Facebook" target="_blank">
                                        <i className="elegant-icon social_facebook"></i>
                                      </Link>
                                    </li>
                                    <li>
                                      <Link href="/#" className="tw" target="_blank" title="Tweet now">
                                        <i className="elegant-icon social_twitter"></i>
                                      </Link>
                                    </li>
                                    <li>
                                      <Link href="/#" className="pt" target="_blank" title="Pin it">
                                        <i className="elegant-icon social_pinterest"></i>
                                      </Link>
                                    </li>
                                  </ul>
                      ...
                      <ul className="list-post">
                          ...
                          <div className="d-flex hover-up-2 transition-normal">
                            ...
                            <div className="post-content media-body">
                              <h6 className="post-title mb-15 text-limit-2-row font-medium">
                                <Link href="/single">The Best Time to Travel to Cambodia</Link>
                              </h6>
                              <div className="entry-meta meta-1 float-left font-x-small text-uppercase">
                        ...
                        <li className="mb-10">
                          <div className="d-flex hover-up-2 transition-normal">
                            ...
                            <div className="post-content media-body">
                              <h6 className="post-title mb-15 text-limit-2-row font-medium">
                                <Link href="/single">20 Photos to Inspire You to Visit Cambodia</Link>
                              </h6>
                              <div className="entry-meta meta-1 float-left font-x-small text-uppercase">
                  ...
                  <div className="comments-area">
                    ...
                    {comments.map((item, i) => (
                      <div className="comment-list wow fadeIn animated" key={i}>
                        <div className="single-comment justify-content-between d-flex">
                          <div className="user justify-content-between d-flex">
                            <div className="thumb">
                              <img src={`/assets/imgs/authors/${item.img}`} alt="" />
                            </div>
                            <div className="desc">
                          ...
                          item.reply.map((cmntr, i) => (
                            <div key={i}>
                              <div className="single-comment depth-2 justify-content-between d-flex mt-50">
                                <div className="user justify-content-between d-flex">
                                  <div className="thumb">
                                    <img src={`/assets/imgs/authors/${cmntr.img}`} alt="" />
                                  </div>
                                  <div className="desc">
                      ...
                      <div className="row">
                        <div className="col-12">
                          <div className="form-group">
                            <textarea className="form-control w-100" name="comment" id="comment" rows={9} placeholder="Write Comment"></textarea>
                          </div>
                        </div>
