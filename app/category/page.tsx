                ...
                <article className="col-lg-4 col-md-6 mb-30 wow fadeInUp animated">
                  <div className="post-card-1 border-radius-10 hover-up">
                    ...
                    <div className="post-content p-30">
                      ...
                      <div className="d-flex post-card-content">
                        <h5 className="post-title mb-20 font-weight-900">
                          <Link href="/single">Put Yourself in Your Customers Shoes</Link>
                        </h5>
                        <div className="entry-meta meta-1 float-left font-x-small text-uppercase">
                ...
                <article className="col-lg-4 col-md-6 mb-30 wow fadeInUp animated" data-wow-delay="0.2s">
                  <div className="post-card-1 border-radius-10 hover-up">
                    ...
                    <div className="post-content p-30">
                      ...
                      <div className="d-flex post-card-content">
                        <h5 className="post-title mb-20 font-weight-900">
                          <Link href="/single">Life and Death in the Empire of the Tiger</Link>
                        </h5>
                        <div className="entry-meta meta-1 float-left font-x-small text-uppercase">
                ...
                <article className="col-lg-4 col-md-6 mb-30 wow fadeInUp animated" data-wow-delay="0.4s">
                  <div className="post-card-1 border-radius-10 hover-up">
                    ...
                    <div className="post-content p-30">
                      ...
                      <div className="d-flex post-card-content">
                        <h5 className="post-title mb-20 font-weight-900">
                          <Link href="/single">When Two Wheels Are Better Than Four</Link>
                        </h5>
                        <div className="entry-meta meta-1 float-left font-x-small text-uppercase">
                        ...
                        <article className="col-md-6 mb-40 wow fadeInUp  animated">
                          <div className="post-card-1 border-radius-10 hover-up">
                            ...
                            <div className="post-content p-30">
                              ...
                              <div className="d-flex post-card-content">
                                <h5 className="post-title mb-20 font-weight-900">
                                  <Link href="/single">Tips for Growing Healthy, Longer Hair</Link>
                                </h5>
                                <div className="post-excerpt mb-25 font-small text-muted">
                        ...
                        <article className="col-md-6 mb-40 wow fadeInUp  animated">
                          <div className="post-card-1 border-radius-10 hover-up">
                            ...
                            <div className="post-content p-30">
                              ...
                              <div className="d-flex post-card-content">
                                <h5 className="post-title mb-20 font-weight-900">
                                  <Link href="/single">Project Ideas Around the House</Link>
                                </h5>
                                <div className="post-excerpt mb-25 font-small text-muted">
                        ...
                        <article className="col-md-6 mb-40 wow fadeInUp  animated">
                          <div className="post-card-1 border-radius-10 hover-up">
                            ...
                            <div className="post-content p-30">
                              ...
                              <div className="d-flex post-card-content">
                                <h5 className="post-title mb-20 font-weight-900">
                                  <Link href="/single">How to Give Yourself a Spa Day from Home</Link>
                                </h5>
                                <div className="post-excerpt mb-25 font-small text-muted">
                                  <p>Graduating from a top accelerator or incubator can be as career-defining for a&nbsp;startup founder&nbsp;as an elite university diploma. The intensive programmes, which…</p>
                                </div>
                          ...
                          <div className="col-md-8 align-self-center">
                            <div className="post-content">
                              ...
                              <h5 className="post-title font-weight-900 mb-20">
                                <Link href="/single">Helpful Tips for Working from Home as a Freelancer</Link>
                        ...
                        <div className="row mb-40 list-style-2">
                          ...
                          <div className="col-md-8 align-self-center">
                            <div className="post-content">
                              ...
                              <h5 className="post-title font-weight-900 mb-20">
                                <Link href="/single">10 Easy Ways to Be Environmentally Conscious At Home</Link>
                              </h5>
                              <div className="entry-meta meta-1 float-left font-x-small text-uppercase">
                        ...
                        <div className="row mb-40 list-style-2">
                          ...
                          <div className="col-md-8 align-self-center">
                            <div className="post-content">
                              ...
                              <h5 className="post-title font-weight-900 mb-20">
                                <Link href="/single">My Favorite Comfies to Lounge in At Home</Link>
                              </h5>
                              <div className="entry-meta meta-1 float-left font-x-small text-uppercase">
                                <span className="post-on">7 August</span>
                                <span className="time-reading has-dot">9 mins read</span>
                        ...
                        <div className="row mb-40 list-style-2">
                          ...
                          <div className="col-md-8 align-self-center">
                            <div className="post-content">
                              ...
                              <h5 className="post-title font-weight-900 mb-20">
                                <Link href="/single">How to Give Your Space a Parisian-Inspired Makeover</Link>
                              </h5>
                              <div className="entry-meta meta-1 float-left font-x-small text-uppercase">
                                <span className="post-on">27 August</span>
                                <span className="time-reading has-dot">12 mins read</span>
                    ...
                    <div className="sidebar-widget widget-about mb-50 pt-30 pr-30 pb-30 pl-30 bg-white border-radius-5 has-border  wow fadeInUp animated">
                      ...
                      <ul className="header-social-network d-inline-block list-inline color-white mb-20">
                        <li className="list-inline-item">
                          <Link href="/#" className="fb" target="_blank" title="Facebook">
                            <i className="elegant-icon social_facebook"></i>
                          </Link>
                        </li>
                        <li className="list-inline-item">
                        ...
                        <ul className="list-post">
                            ...
                            <div className="d-flex bg-white has-border p-25 hover-up transition-normal border-radius-5">
                              <div className="post-content media-body">
                                <h6 className="post-title mb-15 text-limit-2-row font-medium">
                                  <Link href="/single">Spending Some Quality Time with Kids? It’s Possible</Link>
                                </h6>
                                <div className="entry-meta meta-1 float-left font-x-small text-uppercase">
                          ...
                          <li className="mb-30 wow fadeInUp animated">
                            <div className="d-flex bg-white has-border p-25 hover-up transition-normal border-radius-5">
                              <div className="post-content media-body">
                                <h6 className="post-title mb-15 text-limit-2-row font-medium">
                                  <Link href="/single">Relationship Podcasts are Having “That” Talk</Link>
                                </h6>
                                <div className="entry-meta meta-1 float-left font-x-small text-uppercase">
                                  <span className="post-on">12 August</span>
                          ...
                          <li className="mb-30 wow fadeInUp animated">
                            <div className="d-flex bg-white has-border p-25 hover-up transition-normal border-radius-5">
                              <div className="post-content media-body">
                                <h6 className="post-title mb-15 text-limit-2-row font-medium">
                                  <Link href="/single">Here’s How to Get the Best Sleep at Night</Link>
                                </h6>
                                <div className="entry-meta meta-1 float-left font-x-small text-uppercase">
                    ...
                    <div className="sidebar-widget widget_instagram wow fadeInUp animated">
                      ...
                      <div className="instagram-gellay">
                        <ul className="insta-feed">
                          <li>
                            <Link href="/assets/imgs/thumbnail-3.jpg" className="play-video" data-animate="zoomIn" data-duration="1.5s" data-delay="0.1s">
                              <img className="border-radius-5" src="/assets/imgs/news/thumb-1.jpg" alt="" />
                            </Link>
                          </li>
                          <li>
                            <Link href="/assets/imgs/thumbnail-4.jpg" className="play-video" data-animate="zoomIn" data-duration="1.5s" data-delay="0.1s">
                              <img className="border-radius-5" src="/assets/imgs/news/thumb-2.jpg" alt="" />
                            </Link>
                          </li>
                          <li>
                            <Link href="/assets/imgs/thumbnail-5.jpg" className="play-video" data-animate="zoomIn" data-duration="1.5s" data-delay="0.1s">
