...
function Author() {
  ...
  const [singleData, setSingleData] = useState<Author | null>(null);

  const [loading, setLoading] = useState(true);

  useEffect(() => {
    if (id) {
      const author = data.find((item: Author) => item.id.toString() === id);
      setSingleData(author || null);
      setLoading(false);
    }
  }, [id]);
  ...
  if (!singleData) {
    return (
      <Layout>
        <div className="container">Author not found</div>
      </Layout>
    );
  }
                ...
                {singleData && (
                  <div className="author-bio mb-50 bg-white p-30 border-radius-10">
                    <div className="author-image mb-30">
                      <Link href="/author">
                        <img src={`/assets/imgs/authors/${singleData.img}`} alt="" className="avatar" />
                      </Link>
                    </div>
                    <div className="author-info">
                      <h3 className="font-weight-900">
                        <span className="vcard author">
                          <span className="fn">
                            <Link href="/author" title="Posts by Steven" rel="author">
                              {singleData.title}
                            </Link>
                          </span>
                        </span>
                      ...
                      <div className="author-description text-muted">{singleData.desc}</div>
                      <strong className="text-muted">Follow: </strong>
                      <ul className="header-social-network d-inline-block list-inline color-white mb-20">
                        <li className="list-inline-item">
                          <a href="#" className="fb" target="_blank" title="Facebook">
                          ...
                          <div className="post-card-1 border-radius-10 hover-up">
                            ...
                            <div className="post-content p-30">
                              <div className="entry-meta meta-0 font-small mb-10">
                                ...
                                <Link href={`/blog/${item.id}`}>
                                  <span className="post-cat text-success">{item.category}</span>
                                </Link>
                              </div>
