          ...
          <div className="container">
            <div className="row">
              <div className="col-12">
                {/* <!--author box--> */}
                {data.map((item, i) => (
                  <div className="author-bio mb-50 bg-white p-30 border-radius-10" key={i}>
                    <div className="author-image mb-30">
                      <a href={`/author/${item.id}`}>
                        <img src={`/assets/imgs/authors/${item.img}`} alt="" className="avatar" />
                      </a>
                    </div>
                    <div className="author-info">
                      <h3 className="font-weight-900">
                        <span className="vcard author">
                          <span className="fn">
                            <a href={`/author/${item.id}`} title="Posts by Steven" rel="author">
                              {item.title}
                            </a>
                          </span>
                        </span>
