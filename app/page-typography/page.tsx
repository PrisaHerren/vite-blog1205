        ...
        <main className="bg-grey pb-30">
          <div className="container single-content">
            <div className="entry-header entry-header-style-1 mb-50 pt-50">
              <h1 className="entry-title mb-50 font-weight-900 text-center">Typography - Style Guide</h1>
            </div>
            {/*end single header*/}
            ...
            <article className="entry-wraper mb-50">
              ...
              <div className="entry-main-content">
                ...
                <p>
                  ...
                  <a title="WordPress Foundation" href="https://wordpressfoundation.org/">
                    link
                  </a>
                  .
                </p>
                ...
                <p>
                  <strong>
                    abbr Tag (<em>deprecated in HTML5</em>)
                  </strong>
                </p>
                <p>
                  The abbr <abbr title="For The Win">ftw</abbr> stands for “for the win”.
                </p>
                <p>
                ...
                <p>
                  This tag shows strike-through <s>text</s>.
                </p>
                <p>
                ...
                <p>
                  This rarely used tag emulates, which is usually styled like the <code>&lt;code&gt;</code> tag.
                </p>
                <p>
              ...
              <div className="single-social-share clearfix wow fadeIn animated">
                <div className="entry-meta meta-1 font-small color-grey float-left mt-10">
                  ...
                  <span className="hit-count">
                    <i className="elegant-icon icon_star-half_alt mr-5" />
                    Rate: 9/10
                  </span>
                </div>
                ...
                <div className="author-info">
                  <h4 className="font-weight-bold mb-20">
                    <span className="vcard author">
                      <span className="fn">
                        <a href="/author" title="Posted by Barbara Cartland" rel="author">
                          Barbara Cartland
                        </a>
                      </span>
                    </span>
                  ...
                  <a href="/author" className="author-bio-link mb-md-0 mb-3">
                    View all posts (125)
                  </a>
                        ...
                        <div className="col-md-4">
                          <div className="post-thumb position-relative border-radius-5">
                            <div className="img-hover-slide border-radius-5 position-relative" style={{ backgroundImage: "url(assets/imgs/news/news-13.jpg)" }}>
                              <a className="img-link" href="/single" />
                            </div>
                        ...
                        <div className="col-md-8 align-self-center">
                          <div className="post-content">
                            ...
                            <h5 className="post-title font-weight-900 mb-20">
                              <a href="/single">Helpful Tips for Working from Home as a Freelancer</a>
                      ...
                      <div className="row mb-40 list-style-2">
                        ...
                        <div className="col-md-8 align-self-center">
                          <div className="post-content">
                            ...
                            <h5 className="post-title font-weight-900 mb-20">
                              <a href="/single">10 Easy Ways to Be Environmentally Conscious At Home</a>
                            </h5>
                            <div className="entry-meta meta-1 float-left font-x-small text-uppercase">
                  ...
                  <ul className="list-post">
                    <li className="mb-30">
                      <div className="d-flex hover-up-2 transition-normal">
                        <div className="post-thumb post-thumb-80 d-flex mr-15 border-radius-5 img-hover-scale overflow-hidden">
                          <a className="color-white" href="/single">
                            <img src="/assets/imgs/news/thumb-1.jpg" alt="" />
                          </a>
                        </div>
                        <div className="post-content media-body">
                          <h6 className="post-title mb-15 text-limit-2-row font-medium">
                            <a href="/single">The Best Time to Travel to Cambodia</a>
                          </h6>
                          <div className="entry-meta meta-1 float-left font-x-small text-uppercase">
                    ...
                    <li className="mb-10">
                      <div className="d-flex hover-up-2 transition-normal">
                        ...
                        <div className="post-content media-body">
                          <h6 className="post-title mb-15 text-limit-2-row font-medium">
                            <a href="/single">20 Photos to Inspire You to Visit Cambodia</a>
                          </h6>
                          <div className="entry-meta meta-1 float-left font-x-small text-uppercase">
